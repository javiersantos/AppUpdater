...
public interface IAppUpdater {
     ...
     */
    AppUpdater setDialogButtonUpdate(@NonNull String text, OnClickListener onclickListener); //method for onclick
     ...
     */
    AppUpdater setDialogButtonUpdate(@StringRes int textResource, OnClickListener onclickListener); //method for onclick
     ...
     * @return this
     */
    AppUpdater setButtonUpdate(@NonNull String text, OnClickListener onclickListener); //method for onclick
     ...
     * @return this
     */
    AppUpdater setButtonUpdate(@StringRes int textResource, OnClickListener onclickListener); //method for onclick
