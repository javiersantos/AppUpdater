...
import android.content.DialogInterface.OnClickListener; // import for onclik listener
...
public class AppUpdater implements IAppUpdater {
	...
	private OnClickListener onclickListener; // private variable for OnClickListener
    ...
    @Override
    @Deprecated
    public AppUpdater setDialogButtonUpdate(@NonNull String text, OnClickListener onclickListener) //method for onclick
	{
        setButtonUpdate(text, onclickListener);
        return this;
    }

    @Override
    @Deprecated
    public AppUpdater setDialogButtonUpdate(@StringRes int textResource, OnClickListener onclickListener) //method for onclick
	{
        setButtonUpdate(textResource, onclickListener);
        return this;
    }

    @Override
    public AppUpdater setButtonUpdate(@NonNull String text, OnClickListener onclickListener) //method for onclick
	{
        this.btnUpdate = text;
    ...
    @Override
    public AppUpdater setButtonUpdate(@StringRes int textResource, OnClickListener onclickListener) //method for onclick
	{
            ...
            public void onSuccess(Update update) {
                ...
                if (UtilsLibrary.isUpdateAvailable(UtilsLibrary.getAppInstalledVersion(context), update.getLatestVersion())) {
                    ...
                    if (UtilsLibrary.isAbleToShow(successfulChecks, showEvery)) {
                        switch (display) {
                            case DIALOG:
                                alertDialog = UtilsDisplay.showUpdateAvailableDialog(context, titleUpdate, getDescriptionUpdate(context, update, Display.DIALOG), btnDismiss, btnUpdate, onclickListener, btnDisable, updateFrom, update.getUrlToDownload()); //add method for onclick 
                                alertDialog.show();
                                break;
                            case SNACKBAR:
