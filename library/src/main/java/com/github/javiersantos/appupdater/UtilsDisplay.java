...
import android.content.DialogInterface; // import for onclik listener
...
class UtilsDisplay {
    ...
    static AlertDialog showUpdateAvailableDialog(final Context context, String title, String content, String btnNegative, String btnPositive, OnClickListener onclickListener, String btnNeutral, final UpdateFrom updateFrom, final URL apk) // add method for onclick
	{
        ...
        return new AlertDialog.Builder(context)
                .setTitle(title)
                .setMessage(content)
			    .setPositiveButton(btnPositive, onclickListener) //method for onclick
